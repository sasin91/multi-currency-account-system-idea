...
class CashTest extends TestCase
{
    ...
    {
        $revenue = PaymentMethod::driver('Cash')->withdraw(
            'john@example.com',
            7400,
    ...
    {
        $revenue = PaymentMethod::driver('Cash')->refund(
            'john@example.com',
            7400,
            function (PaymentMethodOptions $options) {
                $options
    ...
    {
        $revenue = PaymentMethod::driver('Cash')->deposit(
            'john@example.com',
            7400,
            function (PaymentMethodOptions $options) {
                $options
    ...
    public function testItAddsAPaidDepositumToTheCustomersAccount()
    {
        ...
        PaymentMethod::driver('Cash')->deposit($account, 5000, ['paid_at' => now()]);
    ...
    public function testItDoesNotAddAnUnpaidDepositumToTheCustomersAccount()
    {
        ...
        $depositum = PaymentMethod::driver('Cash')->deposit($account, 5000);
